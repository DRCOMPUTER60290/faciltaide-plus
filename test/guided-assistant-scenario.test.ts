...
describe('guided assistant flow', () => {
  it('presents a coherent question sequence for the Benjamin & Nina scenario', () => {
    const scenarioAnswers: Record<string, string> = {
      ...
      'adult1-unemployment-benefits': 'Oui, indemnisé(e)',
      'adult1-unemployment-amount': '580',
      ...
      'adult2-intent': 'Oui',
      'adult2-situation': 'En situation de handicap',
      'adult2-unemployment-benefits': 'Non',
      ...
      'independent-info': '0',
      'unemployment-info': '0',
      'adult1-prime-activity': 'Non',
      'adult1-rsa': 'Non',
      'adult1-housing-benefits': 'Non',
      'adult1-family-allowances': 'Non',
      'adult1-aah': 'Non',
      'adult1-invalidity-pension': 'Non',
      'pensions-info': 'Non',
      'other-resources-info': 'Non',
      'adult2-salary-info': '0',
      'adult2-independent-info': 'P',
      'adult2-unemployment-info': '0',
      'adult2-prime-activity': 'Non',
      'adult2-rsa': 'Non',
      'adult2-housing-benefits': 'Non',
      'adult2-family-allowances': 'Non',
      'adult2-aah': 'Oui',
      'adult2-aah-amount': '1033',
      'adult2-invalidity-pension': 'Non',
    ...
    const expectedStepIds = [
      ...
      'adult1-unemployment-benefits',
      'adult1-unemployment-amount',
      ...
      'independent-info',
      'unemployment-info',
      'adult1-prime-activity',
      'adult1-rsa',
      'adult1-housing-benefits',
      'adult1-family-allowances',
      'adult1-aah',
      'adult1-invalidity-pension',
      'pensions-info',
      'other-resources-info',
      'adult2-salary-info',
      'adult2-independent-info',
      'adult2-unemployment-info',
      'adult2-prime-activity',
      'adult2-rsa',
      'adult2-housing-benefits',
      'adult2-family-allowances',
      'adult2-aah',
      'adult2-aah-amount',
      'adult2-invalidity-pension',
      'adult2-pensions-info',
      'adult2-other-resources-info',
